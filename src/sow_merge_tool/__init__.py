...
should import the concrete modules instead of depending on this compatibility
surface.
"""
...
# Keep the package path so ``sow_merge_tool.branch_submit`` and
# ``sow_merge_tool.svn_status_provider`` remain importable after the public
# module alias is set.
